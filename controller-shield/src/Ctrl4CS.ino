...
const int   INA226_ADDR_S0_12V    = 0x40;     // INA226 I2C Address (A0=A1=GND)
const int   INA226_ADDR_S0_5V     = 0x41;     // INA226 I2C Address (A0=A1=GND)
const int   INA226_ADDR_S1_12V    = 0x42;     // INA226 I2C Address (A0=A1=GND)
const int   INA226_ADDR_S1_5V     = 0x43;     // INA226 I2C Address (A0=A1=GND)
const int   INA226_ADDR_S2_12V    = 0x44;     // INA226 I2C Address (A0=A1=GND)
const int   INA226_ADDR_S2_5V     = 0x45;     // INA226 I2C Address (A0=A1=GND)
const int   INA226_ADDR_S3_12V    = 0x46;     // INA226 I2C Address (A0=A1=GND)
const int   INA226_ADDR_S3_5V     = 0x47;     // INA226 I2C Address (A0=A1=GND)
const int   INA226_ADDR_S4_12V    = 0x48;     // INA226 I2C Address (A0=A1=GND)
const int 	INA226_ADDR_S4_5V     = 0x49;     // INA226 I2C Address (A0=A1=GND)
...
void printINA226(long *voltage, short *current, long *power) {
  ...
  // print on LCD.
  selectedINA226++;
  if ( selectedINA226 >= (NUMOF_INA226 >> 1) ) selectedINA226 = 0;
