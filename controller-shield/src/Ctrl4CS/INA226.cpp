...
{
    return (readRegister16(INA226_REG_POWER) * (10 * powerLSB)); // The unit was changed to 100mW.
    // return (readRegister16(INA226_REG_POWER) * powerLSB);   // original (the unit is 1W)
}
